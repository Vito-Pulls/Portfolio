...
if (isset($_GET['eliminar'])) {
    ...
    header('Location: ' . BASE_URL . '/admin/index.php?ok=eliminado');
    exit;
}
...
<body class="admin-body">
    ...
    <header class="admin-header">
        ...
        <nav class="admin-header__nav">
            <a href="<?= BASE_URL ?>/admin/newPost.php" class="btn btn--primario">+ Nuevo post</a>
            <a href="<?= BASE_URL ?>/admin/logout.php" class="admin-header__salir">Salir</a>
        </nav>
    </header>
                ...
                <?php else: ?>
                    <?php foreach ($posts as $post): ?>
                        <tr>
                            ...
                            <td>
                                <span
                                    class="admin-badge <?= $post['publicado'] ? 'admin-badge--publicado' : 'admin-badge--borrador' ?>">
                            ...
                            <td class="admin-tabla__acciones">
                                <a href="<?= BASE_URL ?>/admin/editPost.php?id=<?= $post['id'] ?>"
                                    class="admin-enlace">Editar</a>
                                <a href="<?= BASE_URL ?>/admin/index.php?eliminar=<?= $post['id'] ?>"
